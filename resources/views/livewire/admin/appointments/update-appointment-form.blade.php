            ...
            <form wire:submit.prevent="updateAppointment" autocomplete="off">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit Appontment</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div wire:ignore class="input-group date" id="reservationdate"
                                        ...
                                        <input wire:model.defer="state.date" type="text" class="form-control datetimepicker-input"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div wire:ignore class="input-group date" id="timepicker"
                                        ...
                                        <input wire:model.defer="state.time" type="text" class="form-control datetimepicker-input"
                        ...
                        <div class="row">
                            <div class="col-md-12  form-group">
                                ...
                                <textarea id="note" data-note="@this" wire:model.defer="state.note"
                                          ...
                                          style="width: 100%;"
                                          placeholder="Place some text here">{!! $state['note'] !!}</textarea>
                            </div>
